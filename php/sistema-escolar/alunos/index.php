...
<header>
	<div class="row">
		...
		<div class="col-sm-6 text-right h2">
	    	<a class="btn btn-primary" href="form.php"><i class="fa fa-plus"></i> Novo Cliente</a>
...
<?php foreach ($usuarios as $usuario) : ?>
	<tr>
		...
		<td><?php echo $usuario['RA']; ?></td>
		<td id="CPF"><?php echo $usuario['cpf']; ?></td>
		...
		<td class="actions text-right">
			...
			<a href="form.php?id=<?php echo $usuario['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>
